...
def help(bot, update):
    ...
    bot.sendMessage(update.message.chat_id, text = "To search for a song on Spotify, just call the bot by typing @Spotify_Downlo_Bot and then typing your query. Then, just select what category you would like to search under!")
